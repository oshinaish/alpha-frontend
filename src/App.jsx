...
function App() {
  ...
  useEffect(() => {
    axios.get("https://alpha-backend-rhik.onrender.com/get-categories")
      .then((res) => {
  ...
  const uploadFile = async () => {
    ...
    try {
      const res = await axios.post("https://alpha-backend-rhik.onrender.com/upload-pdf", formData, {
        headers: {
  ...
  const handleCategoryChange = async (description, category) => {
    ...
    try {
      await axios.post("https://alpha-backend-rhik.onrender.com/save-category", {
